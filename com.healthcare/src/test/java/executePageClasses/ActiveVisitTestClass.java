...
public class ActiveVisitTestClass extends BaseClass {
  ...
  @Test(dataProviderClass = DataProvider1.class, dataProvider = "login",priority = 0, retryAnalyzer = RetryAnalyzer.class)
  ...
  @Test(dataProviderClass = DataProvider1.class, dataProvider = "login", priority = 1, enabled = false, retryAnalyzer = RetryAnalyzer.class)
