...
public class RegisterAPatientTestClass extends BaseClass {
  ...
  public void verifyToRegisteraAPatient(String uName, String password) throws IOException {
  ...
  @Test(dataProviderClass = DataProvider1.class, dataProvider = "login")
	  ...
	  public void verifyToDeleteARegisteredaAPatient(String uName, String password) throws IOException {
		  lp=new LoginPageClass(driver);
