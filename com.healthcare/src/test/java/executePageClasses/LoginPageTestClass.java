...
public class LoginPageTestClass extends BaseClass {
	...
	@Test(dataProviderClass = DataProvider1.class, dataProvider = "login", retryAnalyzer = RetryAnalyzer.class, groups = {
			"group2" })
	...
	@Test(dataProviderClass = DataProvider1.class, dataProvider = "dp", retryAnalyzer = RetryAnalyzer.class, groups = {
			"group2" })
